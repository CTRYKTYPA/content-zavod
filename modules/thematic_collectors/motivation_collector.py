"""
Модуль для сбора видео по теме "Мотивация".
"""
...
class MotivationCollector:
    """Сборщик видео по теме Мотивация."""
    
    THEME_NAME = "Мотивация"
    THEME_FOLDER = "motivation"
    
    HASHTAGS = [
        "motivation", "inspiration", "success", "mindset", "goals",
        "motivational", "inspirational", "successquotes", "mindsetmatters", "motivationdaily"
    ]
    
    MIN_VIEWS = 600000  # 600к просмотров
    MIN_LIKES = 6000    # 6к лайков
