"""
Модуль для сбора видео по теме "Технологии".
"""
...
class TechCollector:
    """Сборщик видео по теме Технологии."""
    ...
    HASHTAGS = [
        ...
        "technews", "techreview", "techlife", "futuretech", "techtrends"
    ]
    
    MIN_VIEWS = 400000  # 400к просмотров
    MIN_LIKES = 4000    # 4к лайков
