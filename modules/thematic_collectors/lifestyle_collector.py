"""
Модуль для сбора видео по теме "Лайфстайл".
"""
...
class LifestyleCollector:
    """Сборщик видео по теме Лайфстайл."""
    
    THEME_NAME = "Лайфстайл"
    THEME_FOLDER = "lifestyle"
    
    HASHTAGS = [
        "lifestyle", "life", "daily", "vlog", "dayinmylife",
        "lifestyleblogger", "lifestyleinspo", "lifestylegoals", "lifestylevibes", "lifestylephotography"
    ]
    
    MIN_VIEWS = 200000  # 200к просмотров
    MIN_LIKES = 2000    # 2к лайков
